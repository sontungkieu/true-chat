...
5. Outputs
   ...
   - `pdf/main.tex`, `pdf/sections/en/*.tex`, and `pdf/main.pdf`: internship-wide English progress report for BudgetRAG / MemAlign-Qwen, including foundation, BudgetRAG, adaptive heuristic, RLAIF labels, reward/preference construction, selector baselines, multi-judge audit, KV-cache motivation, limitations, future work, expanded appendices, and an English-vs-Vietnamese revision trace.
