...
4. Evaluate against existing baselines
   ...
   - Current reporting result: `feature/rlaif-retrieval-context-v0` has been merged into `internship`, and `pdf/main.tex` / `pdf/main.pdf` now contain the internship-wide BudgetRAG / MemAlign-Qwen report covering Phase 1A through Phase 1D.
...
5. Outputs
   ...
   - `pdf/main.tex` and `pdf/main.pdf`: internship-wide final progress report for BudgetRAG / MemAlign-Qwen, including foundation, BudgetRAG, adaptive heuristic, RLAIF labels, reward/preference construction, selector baselines, multi-judge audit, KV-cache motivation, limitations, and future work.
