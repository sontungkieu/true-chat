...
- Update the internship PDF Main Results with A1 answer-label validation, answer quality by retriever, A1 answer-only selector sweep, and prepared 600-row context-label subset tables, while keeping the final retriever-quality claim blocked on context labels.
