...
- Merge `feature/rlaif-retrieval-context-v0` into `internship` and rewrite `pdf/main.tex` / `pdf/main.pdf` as the internship-wide BudgetRAG / MemAlign-Qwen report covering Phase 1A through Phase 1D, with claim boundaries for offline RLAIF-style evaluation and future KV work.
