...
- Add `rlaif-train` to write an offline `rlaif_policy.json` artifact with fixed, cheapest, best-average, `family_smoothed_best_average`, `linear_reward_model`, and oracle-logged selector baselines.
