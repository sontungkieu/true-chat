...
- Consolidate detailed Markdown experiment reports into the internship PDF: add data-rich Key Findings, phase timeline, full context-label, reward-ablation, pairwise audit, DeepSeek audit, selector, retriever-diversity, and report-source-map sections while keeping A1 answer labels marked as pending.
