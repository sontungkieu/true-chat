...
So the result is not a robust learned-selector win. The current data remains small and the best
simple selector is still a strong exact-signature average baseline when it has coverage.
