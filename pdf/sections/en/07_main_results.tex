...
A1 answer-level quality is now measured. & A1 has 1500/1500 valid MiMo V2.5 answer labels, 1460 clean usable labels, and graph-BM25 has the best mean answer-level reward among the three retrievers. & This is an answer-level signal; final retriever-quality ranking still needs context labels. \\
\bottomrule
\end{tabular}
\end{center}
...
\toprule
Retriever & Quality & Support & Reward & KV cost \\
\midrule
BM25 & 0.899 & 0.899 & 0.617 & 0.605 \\
graph-BM25 & 0.911 & 0.909 & 0.642 & 0.559 \\
hybrid-RRF & 0.862 & 0.862 & 0.546 & 0.673 \\
\bottomrule
\end{tabular}
\end{center}

\textbf{Takeaway:} the retriever-diversity extension has fixed the logged-action coverage problem and now has answer-level quality labels. Graph-BM25 is the strongest mean answer-level retriever in A1, but the context-supervision gap remains:
