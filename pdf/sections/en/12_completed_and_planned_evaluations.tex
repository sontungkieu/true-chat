...
The next-run decision therefore keeps the retriever-diverse branch active but avoids the full 2250-row matrix for now. The recommended follow-up is a 50-query, two-budget run with standard MiMo V2.5 and \code{MAX\_COMPLETION\_TOKENS=2048}, plus a targeted DeepSeek audit over 100 high-impact context rows. Local Qwen profiling is deferred from this branch.
